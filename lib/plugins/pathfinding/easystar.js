 ...
 *
 * MelonJS EasyStar Plugin
 * created by Vasco Borges
 * github.com/vascomotaborges/melonjs-easystar
 *
 * a pathfinding plugin based on EasyStarJS (A* Algorythm)
 ...
 * github.com/vascomotaborges/melonjs-easystar/blob/master/README.md#usage
 *
 *
 */
(function () {
	...
	**/
	...
	/** @scope me.pathfinding.EasyStar.prototype */
	{
	    ...
	    init : function (opts) {
	        ...
	        // API
	        this.enableSync = this.easystar.enableSync;
	        this.enableDiagonals = this.easystar.enableDiagonals;
	        this.enableCornerCutting = this.easystar.enableCornerCutting;
	        this.setIterationsPerCalculation = this.easystar.setIterationsPerCalculation;
	        this.avoidAdditionalPoint = this.easystar.avoidAdditionalPoint;
	        this.setAdditionalPointCost = this.easystar.setAdditionalPointCost;
	        this.setTileCost = this.easystar.setTileCost;
